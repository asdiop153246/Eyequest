...
#pragma warning restore IDE1006
    ...
    protected async System.Threading.Tasks.Task<(T1, T2)> WhenAll<T1, T2>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2);
      return (task1.Result, task2.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3)> WhenAll<T1, T2, T3>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3);
      return (task1.Result, task2.Result, task3.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3, T4)> WhenAll<T1, T2, T3, T4>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3, System.Threading.Tasks.Task<T4> task4)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3, task4);
      return (task1.Result, task2.Result, task3.Result, task4.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3, T4, T5)> WhenAll<T1, T2, T3, T4, T5>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3, System.Threading.Tasks.Task<T4> task4, System.Threading.Tasks.Task<T5> task5)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3, task4, task5);
      return (task1.Result, task2.Result, task3.Result, task4.Result, task5.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3, T4, T5, T6)> WhenAll<T1, T2, T3, T4, T5, T6>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3, System.Threading.Tasks.Task<T4> task4, System.Threading.Tasks.Task<T5> task5, System.Threading.Tasks.Task<T6> task6)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3, task4, task5, task6);
      return (task1.Result, task2.Result, task3.Result, task4.Result, task5.Result, task6.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3, T4, T5, T6, T7)> WhenAll<T1, T2, T3, T4, T5, T6, T7>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3, System.Threading.Tasks.Task<T4> task4, System.Threading.Tasks.Task<T5> task5, System.Threading.Tasks.Task<T6> task6, System.Threading.Tasks.Task<T7> task7)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3, task4, task5, task6, task7);
      return (task1.Result, task2.Result, task3.Result, task4.Result, task5.Result, task6.Result, task7.Result);
    }

    protected async System.Threading.Tasks.Task<(T1, T2, T3, T4, T5, T6, T7, T8)> WhenAll<T1, T2, T3, T4, T5, T6, T7, T8>(System.Threading.Tasks.Task<T1> task1, System.Threading.Tasks.Task<T2> task2, System.Threading.Tasks.Task<T3> task3, System.Threading.Tasks.Task<T4> task4, System.Threading.Tasks.Task<T5> task5, System.Threading.Tasks.Task<T6> task6, System.Threading.Tasks.Task<T7> task7, System.Threading.Tasks.Task<T8> task8)
    {
      await System.Threading.Tasks.Task.WhenAll(task1, task2, task3, task4, task5, task6, task7, task8);
