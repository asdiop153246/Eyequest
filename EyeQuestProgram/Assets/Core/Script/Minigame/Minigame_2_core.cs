...
public class Minigame_2_core : MonoBehaviour
{
    ...
    {
        StartCoroutine(Userdata.Instance.GetComponent<ApiCaller>().MiniGameSession(System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "Game2"));
    ...
    IEnumerator _DoneProcessing()
    {
        ...
        _ScoreCounter++;
        _ScoreCounterUI.text = "BINKS COUNTER : "+_ScoreCounter + "";
